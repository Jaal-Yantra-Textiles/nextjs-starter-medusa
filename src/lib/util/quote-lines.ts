 ...
 *
 * ⚠️ This app has no test runner wired. The assertions for this function live
 * in the storefront's `__tests__/quote-lines.test.ts`; keep the two copies
 * identical rather than letting this one drift untested.
 */
